...
class StudyApp:
    ...
    def save_log(self):
        ...
        if subject and length and description and date:
            try:
                ...
                with open("tools/Study App/storage/logbook.txt", "a") as file:
    ...
    def create_logbook_view_screen(self):
        ...
        try:
            with open("tools/Study App/storage/logbook.txt", "r") as file:
    ...
    def clear_log(self):
        if messagebox.askyesno("Clear Log", "Are you sure you want to clear the logbook?"):
            with open("tools/Study App/storage/logbook.txt", "w") as file:
    ...
    def save_tasks(self):
        with open("tools/Study App/storage/Todo.txt", "w") as file:
            json.dump(self.tasks, file)  # Write tasks list to JSON file

    # Function to load tasks from a file
    def load_tasks(self):
        if os.path.exists("tools/Study App/storage/Todo.txt"):
            with open("tools/Study App/storage/Todo.txt", "r") as file:
                try:
